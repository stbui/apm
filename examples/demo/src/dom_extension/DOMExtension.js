...
Node.prototype.rangeOfWord = function(offset, stopCharacters, stayWithinNode, direction) {
    ...
    if (!direction || direction === 'forward' || direction === 'both') {
        ...
        if (!endNode) {
            endNode = stayWithinNode;
            endOffset =
                stayWithinNode.nodeType === Node.TEXT_NODE
                    ? stayWithinNode.nodeValue.length
...
Node.prototype.enclosingNodeOrSelfWithClassList = function(classNames, stayWithin) {
    for (
        let node = this;
        node && node !== stayWithin && node !== this.ownerDocument;
...
Node.prototype.hasSelection = function() {
    ...
    return (
        ...
        selection.anchorNode.isSelfOrDescendant(this) ||
