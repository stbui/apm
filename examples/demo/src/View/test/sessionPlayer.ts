...
angular.module('playerApp').directive('sessionPlayer', [
    '$interval',
    '$timeout',
    'lodash',
    'sessionDetailsModal',
        ...
        return {
            ...
            link: function ($scope: IScope, $element, t) {
                ...
                function C(activity: IActivity) {
                    ...
                    var b = 0 === activity.time && 0 === activity.index && activity.type === EVENT_TYPE.DOM_SNAPSHOT;
                    if (b) return false;
                ...
                if (!utils.isBrowserNotSupported()) {
                    ...
                    render.onTabHidden(function () {
                        if (render.isTabHidden) {
                            $scope.player.skipToTabShown($scope.timelineValue);
                        }
                    });
