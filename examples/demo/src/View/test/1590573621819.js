  ...
  angular
    ...
    .controller('PlayerController', [
      ...
      function (
        ...
        if (
          ((a.isBrowserNotSupported = k.isBrowserNotSupported()),
          !a.isBrowserNotSupported)
        ) {
          e.init(a),
            ...
            (a.playRecordedSession = function () {
              ...
              l.openSessionInNewWindow(
                b.id,
                b.hasInaccessibleResources,
                'player_offline_button'
              );
            });
          var G,
            H,
          ...
          f.loadCurrentUser().then(function (b) {
            ...
            M.onStatusChange(function (b) {
              ...
              a.sessionPlayerApi.setUserHasGoneOffline(c),
                c
                  ? a.sessionPlayerApi.stopLiveStreaming()
            ...
            N.onStatusChange(function (b) {
              ...
              a.sessionPlayerApi.setUserHasGoneOffline(c),
                c &&
                  (L.discardPendingRequests(),
                  a.sessionPlayerApi.resetStreamingRequest(c));
            }),
            d.onUserPermissionRequestSend(a, function () {
              N.start(),
                L.onStreamingRequestDenied(function () {
                  N.stop(),
                    L.disconnect(),
                    a.sessionPlayerApi.denyStreamingRequest();
                }),
                L.onStreamingRequestApproved(function () {
                  N.stop(),
                    L.disconnect(),
                    a.sessionPlayerApi.approveStreamingRequest();
                }),
                L.onRecorderDisconnected(function () {
                  N.stop(),
                    L.disconnect(),
                    a.sessionPlayerApi.interruptStreamingRequest();
                }),
                L.connect(function () {
            ...
            d.onStopLiveStreaming(a, function () {
              K.disconnect(),
                M.stop(),
                a.sessionPlayerApi.finishLoadingActivities(),
                E();
            });
        }
      },
          ...
          link: function (k, l, m) {
            ...
            function p(a) {
              if (!y.is(':hover') && k.isExpanded) {
                var b = e.findIndex(k.filteredNetworkRequests, [
                  'activityIndex',
                  a,
                ]);
                if (!(b < 0)) {
              ...
              (b.log.details.formattedMessage = d.formattedMessage),
                ...
                (b.log.isMultiLine ||
                  (b.log.details.stackFrames &&
                    b.log.details.stackFrames.length > 0)) &&
                  (b.log.isExpandable = !0),
                a(function () {
                  var a = g.find('.message-container .message');
                  b.log.isExpandable =
                    b.log.isExpandable || c.isEllipsisActive(a[0]);
                }, 250);
            }
            function j(a) {
              try {
          ...
          link: function (c, i, j) {
            function k() {
              i.off('mousedown'),
                ...
                i.off('click'),
                P &&
                  (angular.element(P.node).off('keyup'),
                  angular.element(P.node).off('focusout'));
            }
            function l() {
              i.on('mousedown', B),
                i.on('mousemove', C),
          ...
          link: function (a, b, d) {
            ...
            (a.value = 0),
              ...
              (a.refresh = function (b, d) {
                ...
                (a.loadedTimePercentage = a.timelineValueToPercentage(
                  a.loadedTime
                )),
                  e(),
                  a.pauseActivity
        ...
        return {
          ...
          link: function (a, b, t) {
            ...
            function C(a) {
              if (!a.data) return !1;
              var b =
                0 === a.time && 0 === a.index && a.type === p.DOM_SNAPSHOT;
              if (b) return !1;
            ...
            function G() {
              a.isStreamingLive &&
                ((a.isStreamingLive = !1), Q(), e.fireStopLiveStreaming(a));
            }
            function H() {
              return (
                a.viewerIsCreated &&
                a.timelineIsCreated &&
                a.stepsTimelineIsCreated &&
                !!a.session
              );
            }
            function I(b) {
            ...
            if (!i.isBrowserNotSupported()) {
                  ...
                  render: function (b, d) {
                    ...
                    b.forEach(function (b) {
                      window.ss_debug && console.log(d, b),
                        ...
                        (k.isTabVisibilityChange(b) ||
                          (k.isTopLevel(b) && k.isSnapshot(b))) &&
              ...
              a.activeTool,
                ...
                a.$watch(
                  ...
                  function (b) {
                    b &&
                      ...
                      a.viewerApi.setSessionScreenHeight(
                        a.session.screenHeight
                      ),
                      a.viewerApi.setInitialSettings(a.initialSettings),
                      e.fireVisualizeClicks(
                        a,
                        a.settings.playback.shouldVisualizeClicks
                      ));
                  }
                ),
                ...
                a.$watch(
                  ...
                  function (b) {
                    a.player.changeProlongedInactivitySetting(
                      b,
                      a.timelineValue
                    );
                  }
                ...
                a.$watch('settings.playback.shouldPauseOnMarker', function (b) {
                  b && a.pauseActivity
                    ? a.player.changePauseMarker(
                        a.pauseActivity.time,
                        a.timelineValue
                      )
                    : a.player.changePauseMarker(null, a.timelineValue);
                }),
                a.$watch('settings.playback.shouldVisualizeClicks', function (
                  b
                ) {
                ...
                (a.userPermissionRequest = {
                  ...
                  send: function () {
                    'awaiting-response' != this.state &&
                      ...
                      e.fireUserPermissionRequestSend(a));
                  },
                  cancel: function () {
                    'canceled' != this.state &&
                      ((this.state = 'canceled'),
                      e.fireUserPermissionRequestCanceled(a));
                  },
                  deny: function () {
                    'denied-request' != this.state &&
                      (this.state = 'denied-request');
                  },
                  approve: function () {
                    'approved' != this.state && (this.state = 'approved');
                  },
                  interrupt: function () {
                    'interrupted-request' != this.state &&
                      (this.state = 'interrupted-request');
                  },
                  reset: function () {
                ...
                (a.goToCollaborativeMode = function () {
                  (a.isConfirmationVisible = !1),
                    X !== a.CONTROL_TAKEOVER ? (L(X, !0), O(!0)) : N();
                }),
          ...
          link: function (b, e, l) {
                ...
                if (d) {
                  for (var e = a, f = b; d.contentDocument || d.shadowRoot; ) {
                    ...
                    if (d.contentDocument) {
                      ...
                      (e -= h.left),
                        (f -= h.top),
                        (g = d.contentDocument.elementFromPoint(e, f));
                    }
                    if (
                      (d.shadowRoot &&
                        (g = d.shadowRoot.elementFromPoint(e, f)),
            ...
            function E(a) {
              ...
              return b && b.shadowRoot
                ? b
                : ((b && b.contentWindow) || (b = F()), b.contentWindow);
            }
            function F(a) {
                ...
                if (e) {
                  ...
                  ya.isAttached
                    ? (q(f),
                      r(g),
                      b.viewerOverlay &&
                        b.viewerOverlay.setScrollPosition(Fa.top, Fa.left))
            ...
            function ia(a) {
              ...
              if (
                (a.parentId
                  ...
                  : a.previousSiblingId &&
                    (b = ya.getNode(a.previousSiblingId)),
                b)
              )
            ...
            function ja() {
              return (
                b.initialSettings &&
                b.initialSettings.isAssureCoWorkaroundEnabled()
              );
            }
            function ka(a, b) {
              return (
            ...
            (b.scale = 1),
              ...
              b.$watch('maxHeight', function (a) {
                a &&
                  u(b.maxWidth, a, b.sessionScreenWidth, b.sessionScreenHeight);
              }),
              ...
              (b.getScrollableNodeFromPoint = function (a, b, c, e) {
                for (var f = m(a, b); ; ) {
                  ...
                  if (((f = d.getParentElement(f)), f === g[0] || f === wa[0]))
                    break;
                }
              ...
              (b.getFrameElementOffset = function (a) {
                var b;
                return (
                  angular.isDefined(a) && (b = ya.getNode(a)),
                  ya.getNodeOffset(b)
                );
              }),
              ...
              (b.setIsOffline = function (a) {
                a
                  ? b.viewerOverlay.showOfflineOverlay()
                  : b.viewerOverlay.hideOfflineOverlay();
              }),
        ...
        link: function (b, i, j) {
          function k(a, c) {
            if (((A = a), c || b.isEnabled)) {
              for (
                var d, e = 0;
                e < b.filteredSteps.length &&
                b.filteredSteps[e].activityIndex < A;
          ...
          (b.updateStepsTimeline = function (a, b) {
            ...
            (b.selectStep = function (a) {
              if (
                !(b.selectedStep === a || a < 0 || a >= b.filteredSteps.length)
              ) {
        ...
        return (
          ...
          (f.prototype = {
            ...
            isLastActivity: function (a) {
              return (
                !!this._asyncIterator.isFinished() &&
                a === this._asyncIterator.peekLast()
              );
            },
            ...
            getIteratorFromClosestSnapshotToFirstTabShown: function (a, b) {
              ...
              return new e(this._asyncIterator, function (a) {
                return (
                  ...
                  ((g =
                    c.isTabVisible(a) ||
                    (c.isTopLevel(a) && c.isVisibleSnapshot(a))),
                  a.time < b)
                );
              });
            },
      ...
      function (a, b) {
        return {
          ...
          isTabVisible: function (c) {
            return (
              c.type === a.VISIBILITY_CHANGE &&
              c.data.visibilityState === b.VISIBLE
            );
          },
    ...
    function (a, b) {
      ...
      return (
        (c.prototype = {
          next: function (a) {
            this._isPending()
              ? this._scheduleOperation('next', a)
              : a(this._syncSlice.next());
          },
          peek: function (a) {
            this._isPending()
              ? this._scheduleOperation('peek', a)
              : a(this._syncSlice.peek());
          },
          peekLast: function () {
  ...
  angular.module('playerApp').factory('BrokerWebSocketClient', [
    ...
    function (a) {
      function b(a, e, f) {
        ...
        (g.reconnectService = new c(g, h, i)),
          (g.connectorService = new d(a, e));
      }
      function c(a, b, c) {
        var d = this;
        (d.client = a),
          (d.heartbeatInterval = b),
          (d.maxRetries = c),
          (d.retries = 0),
          (d.interval = null);
      }
      ...
      return (
        ...
        (b.prototype = {
            ...
            return (
              ...
              !b.isSupported() || c.isDisconnected
                ...
                : (c.reconnectService.stop(),
                  ...
                  (c.socket = null),
                  void (c.eventListeners = c.eventListeners.filter(function (
                    a
                  ) {
          ...
          send: function (a) {
            ...
            if (!b.isDisconnected)
              return b.isOpen()
                ? void b.socket.send(a)
                : void b.requestsQueue.push(a);
          },
        ...
        (d.prototype = {
            ...
            var d = this,
              ...
              f = function (d, f, g, h) {
                if (!e) {
                  ...
                  return i
                    ? ((e = !0), c({ error: 'broker unreachable' }))
                    : void 0;
                }
              };
            a.forEach(function (a) {
          ...
          connect: function (a) {
            ...
            b.initialConnect(function (c, d, e) {
              ...
              if (f && !d.isRecorderClientBrokerConnected)
                return a({ error: 'broker unreachable' });
              var g = {};
              (g[d.node] = !0),
    ...
    .factory('DocumentNode', [
      ...
      function (a, b, c, d, e, f, g, h, i, j, k) {
            ...
            if (d) {
              ...
              if (e) {
                ...
                var f = Y(a.documentElement),
                  g = Y(e);
                Object.assign(g, f),
                  g.adoptedStyleSheets &&
                    (b.adoptedStyleSheetNodes[g.nodeId] = e);
              }
            }
          }
        }
        function r(a, b) {
          ...
          if (b.hasContentElements && a.createShadowRoot)
            return a.createShadowRoot();
        ...
        function w(a) {
          this.isAttached &&
            ...
            x.call(
              this,
              a,
              'img, input, iframe, canvas, embed, object, video',
              'width'
            ),
            x.call(
              this,
              ...
              .each(function (b, c) {
                (e = c.getAttribute(d)),
                  e &&
                    ...
                    a(f.setAttribute.bind(f), 0, !0, c, d, e));
              });
        }
        function y(a, b) {
          var c,
        ...
        function H(a) {
          ...
          I(a, function (a) {
            (b = Y(a)),
              ...
              a.shadowRoot &&
                ((b = Y(a.shadowRoot)),
                delete c.adoptedStyleSheetNodes[b.nodeId]);
          });
        }
        function I(a, b) {
          for (var c, d, e = [a]; e.length > 0; )
            if ((c = e.pop())) {
              if (((d = b(c)), d === !1)) return;
              if (c.childNodes)
                for (var f = c.childNodes.length - 1; f >= 0; f--)
                  e.push(c.childNodes[f]);
            }
        }
        function J(a) {
        ...
        function L(a, b, c) {
          if (b.childNodes && b.childNodes.length > 0)
            for (var d = b.childNodes.length - 1; d >= 0; d--)
              a.push({ parent: c, node: b.childNodes[d] });
        }
        function M(a, b, c) {
          var d = {};
          switch (a.nodeType) {
        ...
        function V(a, d) {
          ...
          c.matchesSelector(a, 'script')
            ...
            : c.matchesSelector(a, 'link[rel="import"]') &&
              g.attr('href', 'javascript:void(0);');
          var j = [];
        ...
        return (
          ...
          (Z.prototype.replaceDocumentElement = function (a, b) {
            ...
            c.matchesSelector(a, 'html') &&
              e &&
              ((e.documentElement = a), G.call(d, a, b), t.call(d, e));
          }),
          ...
          (Z.prototype.setAttribute = function (a, b, d) {
            if (!X(a, b, d)) {
              if (
                c.matchesSelector(a, 'link[rel="stylesheet"],img') &&
                ('href' === b || 'src' === b)
              ) {
            ...
            b._batches.next(function (c) {
              ...
              b._onRendering(),
                (b._batchExecutor = setTimeout(function () {
                  b._stopped ||
                    (b._render.render(d, 'instantPlayback'), b._replayLoop(a));
                }, 0));
            });
          },
        }),
        ...
        (c.prototype = {
          ...
          _getNextFrameLength: function (a) {
            var b = this._activities.peekLast(),
              c = b.time - a.time;
            return c > this._maxLag
              ? 500
              : this._millisecondsPerFrame * Math.ceil(c / 100);
          },
          ...
          _replayLoop: function (a) {
            ...
            b._frames.next(function (c) {
              ...
              f.isFirstLiveActivity || h > b._maxLag
                ? (d = 0)
                : ((d = (f.time - b._timer.time) / b._speed),
                  (d = Math.max(0, d - b._delay)));
              var i = Date.now() + d;
              b._onRendering(),
      ...
      function (a, b, c, d) {
        ...
        function f(a) {
          a.settings.general = {
            ...
            liveSeparatePipeline:
              b.getQueryParameter('live_separate_pipeline') === !0,
            isAssureCoWorkaroundEnabled:
              b.getQueryParameter('assure_co_workaround') === !0,
          };
        }
        function g(a) {
        ...
        (f.prototype = {
          ...
          jumpToTime: function (a) {
            ...
            if (a < b.time) {
              ...
              var c = this._activities.getIteratorFromClosestSnapshotBetween(
                b,
                a
              );
          ...
          jumpToActivity: function (a) {
            ...
            if (a.time < b.time) {
              this._render.reset();
              var c = this._activities.getIteratorFromClosestSnapshotToActivity(
                a
              );
            } else
              var c = this._activities.getIteratorFromClosestSnapshotBetweenActivities(
                b,
                a
              );
            (this._playback = this._createInstantPlayback(c)),
          ...
          goLive: function (a) {
            ...
            (this._playback = this._createLivePlayback(a, b)),
          ...
          skipToTabShown: function (a) {
            ...
            if (
              b._isPlayingNormal() &&
              b._config.skipProlongedInactivity &&
              !b._skippingToTabShown
            ) {
              ...
              (b._playback = b._createNormalPlayback(a, f, g)),
                b._playback.replay(function () {
                  ...
                  var d = b._activities.getIteratorFromClosestSnapshotToFirstTabShown(
                    a,
                    c
                  );
          ...
          _createInstantPlayback: function (a) {
            ...
            return (
              b.onBuffering(this._onBuffering),
              b.onRendering(this._onRendering),
              b
            );
          },
      ...
      function (a, b, c, d, e, f, g, h) {
        ...
        function l(a, b) {
          ...
          return (
            f.forEach(a, function (a, f) {
              return (
                !(a.time > b) &&
                (e.push(a), (c = a.timestamp), void (d = a.index))
              );
            }),
        ...
        return (
          (m.prototype.loadSession = function () {
            ...
            return (
              (a = e.logId
                ? c.getSessionLog(e.sessionId, e.logId)
                : c.getSession(e.sessionId)),
              b.all([g, a]).then(
                function (a) {
      ...
      return (
        (a.prototype = {
          next: function () {
            return this._isDone()
              ? { done: !0 }
              : { done: !1, value: this.array[this.index++] };
          },
          peek: function () {
            return this._isDone()
              ? { done: !0 }
    ...
    .factory('UserClick', [
      ...
      function (a, b, c) {
        function d(b, c) {
          ...
          return (
            $(d).css({ top: b - a / 2 + 'px', left: c - a / 2 + 'px' }),
            $(d).css(g),
            d
          );
        }
