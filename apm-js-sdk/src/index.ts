...
import { HttpInterceptorHandler } from './http-interceptor';
...
report.push({
  performance: performance.collection(),
  resource: resource.collection()
});

const exceptionInterceptorHandler = new ExceptionInterceptorHandler();
